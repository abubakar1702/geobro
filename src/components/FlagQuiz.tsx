              ...
              <div className={`flex ${message && "hidden"} justify-center mx-4`}>
                <div className="flex flex-col">
                  {fourRandomCountry.slice(0, 2).map((country, index) => (
                    <button
                      className="p-4 font-bold h-28 w-40 border-solid border-4 border-sky-600 rounded-md m-2"
                ...
                <div className="flex flex-col">
                  {fourRandomCountry.slice(2, 4).map((country, index) => (
                    <button
                      className="p-4 font-bold w-40 h-28 border-solid border-4 border-sky-600 rounded-md m-2"
                      onClick={() => handleAnswer(country)}
                      key={index + 2}
                    >
                      {country.name}
